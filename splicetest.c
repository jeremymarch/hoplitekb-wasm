...
printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
if (ucsplice(a, &lenA, maxA, 0, 0, (UCS2[]){5,6,7,8}, 3) == false)
{
    printf("test failed\n");
    exit(1);
}
...
printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
if (ucsplice(a, &lenA, maxA, 1, 0, (UCS2[]){5,6,7,8}, 3) == false)
{
    printf("test failed\n");
    exit(1);
}
...
else
{
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 2, 0, (UCS2[]){5,6,7,8}, 3) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 4, 0, (UCS2[]){5,6,7,8}, 3) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 5, 0, (UCS2[]){5,6,7,8}, 3) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 4, 1, (UCS2[]){5,6,7,8}, 3) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 0, 1, (UCS2[]){5,6,7,8}, 3) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, lenA - 1, 1, (UCS2[]){6,6,7,8}, 1) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 0, 1, NULL, 0) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 4, 1, NULL, 0) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    if (ucsplice(a, &lenA, maxA, 0, 2, (UCS2[]){6}, 1) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printf(" (len: %zu)\n", lenA);
    //splice(ucs2, len, BUFFER_LEN, 0, 3, (UCS2[]){GREEK_SMALL_LETTER_RHO_WITH_DASIA}, 1);
    if (ucsplice(a, &lenA, maxA, 0, 3, (UCS2[]){6}, 1) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printf(" (len: %zu)\n", lenA);
    //splice(ucs2, len, BUFFER_LEN, 0, 3, (UCS2[]){GREEK_SMALL_LETTER_RHO_WITH_DASIA}, 1);
    if (ucsplice(a, &lenA, maxA, lenA-1, 1, (UCS2[]){6,7,8}, 3) == false)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 0, 0, (UCS2[]){5,6,7,8}, 4) == true)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 4, 0, (UCS2[]){5,6,7,8}, 4) == true)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 5, 0, (UCS2[]){5,6,7,8}, 4) == true)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, -1, 0, (UCS2[]){5,6,7,8}, 2) == true)
    {
        printf("test failed\n");
        exit(1);
    }
    ...
    printa(a, lenA);
    printf(" (len: %zu)\n", lenA);
    if (ucsplice(a, &lenA, maxA, 5, 1, (UCS2[]){5,6,7,8}, 3) == true)
    {
        printf("test failed\n");
        exit(1);
    }
