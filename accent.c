...
0x00B7,//GREEK_ANO_TELEIA, //raised dot
...
const UCS2 basicGreekLookUp[][3] = {
    ...
    /* 03DC */ { GREEK_LETTER_DIGAMMA, 0, DIGAMMA_SORT },
    /* 03DD */ { GREEK_SMALL_LETTER_DIGAMMA, 0, DIGAMMA_SORT },
    /* 03DE */ { GREEK_LETTER_KOPPA, 0, KOPPA_SORT },
    /* 03DF */ { GREEK_SMALL_LETTER_KOPPA, 0, KOPPA_SORT },
    ...
    /* 03FA */ { GREEK_CAPITAL_LETTER_SAN, 0, SAN_SORT },
    /* 03FB */ { GREEK_SMALL_LETTER_SAN, 0, SAN_SORT },
